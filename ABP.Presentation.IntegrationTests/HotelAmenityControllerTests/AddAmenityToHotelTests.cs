...
{
    public class AddAmenityToHotelTests : IClassFixture<ABPWebApplicationFactory>
    {
        ...
        public AddAmenityToHotelTests(ABPWebApplicationFactory factory)
        {
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnCreated_WhenSuccess()
        {
            // Arrange
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnUnauthorized_WhenTokenIsInvalidOrMissing()
        {
            // Arrange
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnForbidden_WhenUserIsNotAdmin()
        {
            // Arrange
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnNotFound_WhenHotelDoesNotExist()
        {
            // Arrange
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnNotFound_WhenAmenityDoesNotExist()
        {
            // Arrange
        ...
        [Fact]
        public async Task AddAmenityToHotel_Should_ReturnConflict_WhenAmenityAlreadyExists()
        {
            // Arrange
            var hotel = _fixture.Build<Hotel>()
                .Without(x => x.HotelAmenity)
